                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-700">
                        <tr class="text-gray-300 hover:bg-slate800/50 transition duration-200 font-poppins">
                            ...
                            <td class="px-6 py-4">
                                <img src="" alt="" class="w-16 h-16 rounded-lg object-cover">
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">Nome do Produto</td>
                            <td class="px-6 py-4 whitespace-nowrap">R$ 99,99</td>
                            <td class="px-6 py-4 whitespace-nowrap">Categoria</td>
                            <td class="px-6 py-4 whitespace-nowrap">10</td>
                            <td class="px-6 py-4 whitespace-nowrap">Descrição do produto</td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex gap-3">
                                    ...
                                    <button class="flex items-center justify-center w-8 h-8 bg-gradient-to-r from-[#ef4444] to-[#dc2626] rounded-lg hover:opacity-90 transition duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-white">
