                    ...
                    <div class="bg-gray-800 rounded-lg p-6 space-y-6">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span>R$
                                    {{ number_format(
                                        $itensCarrinho->sum(function ($item) {
